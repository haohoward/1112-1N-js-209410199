...
const computeSalary2 = (salary2) => {
  salary2.forEach((person) => {
    ...
    summary2.male.average = (summary2.male.total / summary2.male.count).toFixed(
      1
    );
    summary2.female.average = (
      summary2.female.total / summary2.female.count
    ).toFixed(1);
  });
};
